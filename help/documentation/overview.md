...
このたびは、Sites Optimizer ドキュメントをご利用いただき、誠にありがとうございます。 Sites Optimizerを使用してAEM サイトを最適化する方法について説明します。

## Site Optimizer の基本

AEM Sites Optimizer のドキュメントを参照して、ホームダッシュボード、設定、最適化のインサイトを得るための機会リストなど、主要な UI コンポーネントについて学びます。
...
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">詳細情報</span>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Trial">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./trial.md" title="体験版" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="./assets/basics/card.png" alt="体験版"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
